...
const Footer = ({ id }: any) => {
  return (
    <footer className="w-full py-8 sm:py-10 text-slate-400 text-sm bg-gradient-to-br from-[#232526]/90 to-[#414345]/90 rounded-2xl shadow-inner border-t border-slate-800/40 backdrop-blur-xl">
